 ...
 * upper bounds.
 */
static	EDLINE	*u_lbound = NULL; /* line just prior to first changed line */
static	EDLINE	*u_ubound = NULL; /* line just after the last changed line */

static	EDLINE	*u_lline  = NULL; /* bounds of the saved lines */
static	EDLINE	*u_uline  = NULL;

static	int	u_col;
static	bool	u_valid = false;  /* is the undo buffer valid */

/*
 * Local forward declarations
 */
static EDLINE *copyline(EDLINE *l);
static	void u_lsave(EDLINE *l, EDLINE *u);
static	void	u_lfree(void);
 ...
 */
void
u_save(EDLINE *l, EDLINE *u)
{
	EDLINE	*nl;			/* copy of the current line */
...
static	EDLINE	*u_line;		/* pointer to the line we last saved */
static	EDLINE	*u_lcopy = NULL;	/* local copy of the original line */
